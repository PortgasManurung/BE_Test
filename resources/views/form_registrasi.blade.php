          ...
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="card-body">
                      <form action="{{ url('form_registrasi') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="city_of_birth" type="text" class="flatpickr flatpickr-input form-control" id="checkin-date">
                            </div>
                            <div class="form-group">
                                <label for="#">Agama</label><span class="text-danger">*</span>
                                <select class="form-control" id="exampleFormControlSelect1" placeholder="religion" name="agama">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="#" placeholder="Nomor HP " name="phone">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="#" placeholder="Nomor KTP" name="ktp">
                            </div>
                            <div class="form-group">
                                <label for="#"> File KTP</label><span class="text-danger">*</span>
                                <input type="file" class="form-control" id="#" placeholder=" KTP" name="ktp_file">

                            </div>
                            <div class="form-group">
                                <label for="#">Nama Bank </label><span class="text-danger">*</span>
                                <select class="form-control" id="exampleFormControlSelect1" placeholder="Nama Bank" name="bank_id">
                                    @foreach ($bank as $b)
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="#" placeholder="Linked In" name="linkedin">
                            </div>
                        </div>
                    </div><br>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" placeholder="Nama Universitas" name="education_id">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" placeholder="Nama Universitas" name="university_id">
                                    ...
                                    <div class="input-group" name="#">
                                        <input type="text" class="form-control mr-2" id="#"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="masih">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleTextarea1" rows="6" name="deskripsi"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="#"> File</label>
                                                    <input type="file" class="form-control" id="#" placeholder="" name="file_org">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row ">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="#" placeholder="File CV.pdf" name="cv">
                            </div>
                            <div class="form-group">
                                <label for="#">Past Photo</label><span class="text-danger">*</span>
                                <input type="file" class="form-control" id="#" placeholder="Photo.jpg" name="photo">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="#"> Portofolio</label>
                                <input type="file" class="form-control" id="#" placeholder="Portofolio.pdf" name="portfolio">
                            </div>
                        </div>
                    </div><br>
